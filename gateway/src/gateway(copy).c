...
typedef struct _ProductDataDefine {
    ...
    TYPE_DEF_TEMPLATE_BOOL    m_sweeper;
	TYPE_DEF_TEMPLATE_FLOAT   m_fumes;
...
static void InitDataTemplate(void)
{
    ...
    dataTemplates[7].data_property.key = "m_sweeper";
    dataTemplates[7].data_property.data = &productData.m_sweeper;
    dataTemplates[7].data_property.type = TYPE_TEMPLATE_BOOL;
    dataTemplates[7].state = eNOCHANGE;

	dataTemplates[8].data_property.key = "m_fumes";
	dataTemplates[8].data_property.data = &productData.m_fumes;
	dataTemplates[8].data_property.type = TYPE_TEMPLATE_FLOAT;
